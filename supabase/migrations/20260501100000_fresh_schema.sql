-- ============================================================
-- TransferOps Fresh Schema Migration
-- Tables: user_profiles, agencies, drivers, vehicles, bookings
-- Timestamp: 20260501100000
-- This migration drops and recreates all tables cleanly.
-- ============================================================

-- 1. DROP TABLES (reverse dependency order), then ENUM TYPES
